  ...
  public function manageNotification($id){
  	...
  	if(sizeof($result) > 0){
        ...
        if(intval($result['email_pin']) == 1){
          ...
          $text = "as PIN every you have money transfer transaction from ".env('APP_NAME').". This is an autogenerated code everytime there's a login so do not share this to anyone unless authorized.";
        }
